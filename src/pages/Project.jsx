    ...
    const projects = [
        {
            ...
            status: "En cours",
            image: "/images/school_project.jpg",
            progress: 65
        },
        {
        ...
        },
        {
            ...
            status: "Annulé",
            image: "/images/health_center.jpg",
            progress: 0
        },
    ];
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <HeroTitle
                ...
                buttons={[
                    {text: "Voir les projets en cours", path: "#projets-en-cours", variant: "primary"},
                    {text: "Proposer un projet", path: "/proposer-projet", variant: "secondary"}
                ]}
            />
