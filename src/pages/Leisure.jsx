    ...
    const leisureCategories = [
        {
            ...
            icon: <EmojiNatureRoundedIcon className="w-8 h-8 text-emerald-600"/>,
            activities: [
                {
        ...
        },
        {
            ...
            icon: <ImagesearchRollerRoundedIcon className="w-8 h-8 text-emerald-600"/>,
            activities: [
                {
        ...
        },
        {
            ...
            icon: <SportsEsportsRoundedIcon className="w-8 h-8 text-emerald-600"/>,
            activities: [
                {
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <section className="py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-4xl font-bold text-center bg-gradient-to-r from-emerald-600 to-emerald-800 bg-clip-text text-transparent mb-16">
                            ...
                            <div key={index} className="relative">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                    {category.activities.map((activity, aIndex) => (
                                        <div key={aIndex}
                                             className="group relative border-l-4 border-emerald-600 pl-6 hover:pl-8 transition-all duration-300">
                                            ...
                                            <a
                                                href={activity.link}
                                                className="inline-block text-emerald-600 font-medium after:content-[''] after:block after:w-0 after:h-0.5 after:bg-emerald-600 after:transition-all group-hover:after:w-full"
                                            >
                                                En savoir plus
                                            </a>
                                        </div>
