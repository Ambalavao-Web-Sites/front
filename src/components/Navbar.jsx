...
const Navbar = () => {
    ...
    const navItems = [
        ...
        },
        {
            ...
            showArrow: true,
            subItems: [
                {path: '/projets/liste', label: 'Projets'},
                {path: '/projets/partenaires', label: 'Partenaires'},
                {path: '/projets/associations', label: 'Associations'}
            ]
        },
        {
            path: '/tourisme',
            ...
            showArrow: true,
            subItems: [
                {path: '/tourisme/activites', label: 'Tourisme'},
                {path: '/tourisme/loisirs', label: 'Loisirs'}
            ]
        }
    ];
