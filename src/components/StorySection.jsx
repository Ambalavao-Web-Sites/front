        ...
        <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16">
            <div className="max-w-5xl mx-auto px-4 sm:px-6">
                ...
                <div className="relative">
                    ...
                    <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#228B22] via-[#228B22]/50 to-transparent" />

                    <div className="space-y-8 md:space-y-16">
                        {historyData.map((item, index) => (
                            <div key={index} className="relative">
                                {/* Timeline dot - hidden on mobile */}
                                <div className="hidden md:block absolute left-1/2 w-4 h-4 rounded-full bg-slate-900 border-2 border-[#228B22] transform -translate-x-1/2 z-10">
                                ...
                                <div className={`flex flex-col md:flex-row ${
                                    ...
                                    <div className={`w-full md:w-1/2 ${
                                        ...
                                        <div className="group bg-slate-800/30 backdrop-blur-sm p-6 rounded-xl border border-slate-700 hover:border-[#228B22]/30 transition-all duration-300">
                                            {/* Header */}
                                            <div className="flex items-center gap-4 mb-4">
                                                <div className="bg-slate-900 p-2 rounded-lg group-hover:bg-[#228B22]/10 transition-colors">
                                                    {item.icon}
                                                </div>
                                                <span className="bg-[#228B22]/10 text-[#228B22] px-3 py-1 rounded-full text-sm font-medium">
                          {item.year}
                        </span>
                                            </div>
